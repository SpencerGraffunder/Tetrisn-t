...
class Game(States):
	...
	def draw(self, screen):
		...
		# display score
		score_str1 = 'Score:'
		text.draw(screen, score_str1, 'MEDIUM', ((BOARD_WIDTH + 4 + 4) * TILE_SIZE, (BOARD_HEIGHT - 3) * TILE_SIZE), (0, 128, 0))

		score_str2 = '%d' % (self.score)
		text.draw(screen, score_str2, 'MEDIUM',  ((BOARD_WIDTH + 4 + 4) * TILE_SIZE, (BOARD_HEIGHT - 2) * TILE_SIZE), (0, 128, 0))

		# display level
		level_str = 'Level: %d' % (self.current_level)
		text.draw(screen, level_str, 'MEDIUM', ((BOARD_WIDTH + 4 + 4) * TILE_SIZE, (BOARD_HEIGHT - 4) * TILE_SIZE), (0, 128, 0))
